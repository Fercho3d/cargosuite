...
return [
    ...
    */
    ...
    'features' => [
        // Registro público deshabilitado: los usuarios internos se dan de
        // alta por un administrador (sistema interno, no autoservicio).
        ...
        // Passkeys (WebAuthn) pendiente: la tabla requiere ajustar la PK
        // `usr_id`. Se habilitará en una etapa posterior.
        // Features::passkeys([
        //     'confirmPassword' => true,
        // ]),
    ],
